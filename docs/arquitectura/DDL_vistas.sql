...
SELECT
    ...
    /* Grafico: gráfico VERTICAL PRE-COMPUTADO (multi-línea, monospace) del parámetro en este
       componente: cada × es una muestra a la altura de su valor (eje Y), columnas = fechas (eje X),
       líneas ······=LC y ------=LP rotuladas, etiqueta ×valor en cada punto. El central lo COPIA
       (o re-delega y copia) dentro de un bloque ```; ⛔ NUNCA lo dibuja a mano. */
    CONCAT(
        Parametro, N' — ', Compartimiento, N' (ppm)',
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 7=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 7=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 6=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 6=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 5=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 5=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 4=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 4=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 3=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 3=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 2=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 2=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n1/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n1 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n2/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n2 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n3/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n3 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n4/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n4 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n5/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n5 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(n6/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(n6 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 1=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(LC AS decimal(18,1))) WHEN 1=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'+', CASE WHEN f1 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(f1)),7) END, CASE WHEN f2 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(f2)),7) END, CASE WHEN f3 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(f3)),7) END, CASE WHEN f4 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(f4)),7) END, CASE WHEN f5 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(f5)),7) END, CASE WHEN f6 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(f6)),7) END, N' ', CHOOSE(MONTH(f6), N'Jan',N'Feb',N'Mar',N'Apr',N'May',N'Jun',N'Jul',N'Aug',N'Sep',N'Oct',N'Nov',N'Dec')
    ) AS Grafico
FROM g
CROSS APPLY (SELECT MIN(x) AS mn, MAX(x) AS mx FROM (VALUES (n1),(n2),(n3),(n4),(n5),(n6)) t(x)) mm
CROSS APPLY (SELECT CASE WHEN ISNULL(LC,0) > ISNULL(mm.mx,0) THEN LC ELSE mm.mx END AS vtop) b0
CROSS APPLY (SELECT CASE WHEN b0.vtop>0 AND LC IS NOT NULL THEN CAST(ROUND(LC/b0.vtop*7,0) AS int) ELSE -1 END AS rLC,
                    CASE WHEN b0.vtop>0 AND LP IS NOT NULL THEN CAST(ROUND(LP/b0.vtop*7,0) AS int) ELSE -1 END AS rLP) b1;
GO
