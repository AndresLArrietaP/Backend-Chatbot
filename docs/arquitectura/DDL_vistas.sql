...
WITH b AS (
    SELECT
        ...
        STUFF(CONCAT(
            ...
            CASE WHEN Pb_ppm>ISNULL(Pb_LP,9999) THEN ' · Pb='+CONVERT(varchar(20),CAST(Pb_ppm AS decimal(18,1)))+'('+ISNULL('LP'+CONVERT(varchar(20),CAST(Pb_LP AS decimal(18,1))),'')+')'+':P' ELSE '' END,
            CASE WHEN Sn_ppm>ISNULL(Sn_LP,9999) THEN ' · Sn='+CONVERT(varchar(20),CAST(Sn_ppm AS decimal(18,1)))+'('+ISNULL('LP'+CONVERT(varchar(20),CAST(Sn_LP AS decimal(18,1))),'')+')'+':P' ELSE '' END,
