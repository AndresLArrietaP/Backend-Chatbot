...
SELECT te.Equipo, te.Compartimiento, te.Parametro,
    CONCAT(
        ...
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=7 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 7=b1.rLC THEN N'·······' WHEN 7=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 7=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 7=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=6 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 6=b1.rLC THEN N'·······' WHEN 6=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 6=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 6=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=5 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 5=b1.rLC THEN N'·······' WHEN 5=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 5=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 5=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=4 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 4=b1.rLC THEN N'·······' WHEN 4=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 4=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 4=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=3 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 3=b1.rLC THEN N'·······' WHEN 3=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 3=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 3=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=2 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 2=b1.rLC THEN N'·······' WHEN 2=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 2=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 2=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'|', CASE WHEN p.n1 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n1/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n1 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n2 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n2/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n2 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n3 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n3/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n3 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n4 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n4/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n4 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n5 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n5/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n5 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN p.n6 IS NOT NULL AND b0.vtop>0 AND CAST(ROUND(p.n6/b0.vtop*7,0) AS int)=1 THEN RIGHT(N'       '+N'×'+CONVERT(varchar(12),CAST(p.n6 AS decimal(18,1))),7) WHEN 1=b1.rLC THEN N'·······' WHEN 1=b1.rLP THEN N'-------' ELSE N'       ' END, CASE WHEN 1=b1.rLC THEN N' LC '+CONVERT(varchar(12),CAST(te.LC AS decimal(18,1))) WHEN 1=b1.rLP THEN N' LP '+CONVERT(varchar(12),CAST(te.LP AS decimal(18,1))) ELSE N'' END,
        CHAR(10), N'+', CASE WHEN te.f1 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(te.f1)),7) END, CASE WHEN te.f2 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(te.f2)),7) END, CASE WHEN te.f3 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(te.f3)),7) END, CASE WHEN te.f4 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(te.f4)),7) END, CASE WHEN te.f5 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(te.f5)),7) END, CASE WHEN te.f6 IS NULL THEN N'       ' ELSE RIGHT(N'       '+CONVERT(varchar(2),DAY(te.f6)),7) END, N' ', CHOOSE(MONTH(te.f6), N'Jan',N'Feb',N'Mar',N'Apr',N'May',N'Jun',N'Jul',N'Aug',N'Sep',N'Oct',N'Nov',N'Dec')
    ) AS Grafico
...
CROSS APPLY (SELECT CASE WHEN b0.vtop>0 AND te.LC IS NOT NULL THEN CAST(ROUND(te.LC/b0.vtop*7,0) AS int) ELSE -1 END AS rLC,
                    CASE WHEN b0.vtop>0 AND te.LP IS NOT NULL THEN CAST(ROUND(te.LP/b0.vtop*7,0) AS int) ELSE -1 END AS rLP) b1;
GO
