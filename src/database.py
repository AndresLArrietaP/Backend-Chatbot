...
if not DATABASE_URL:
    raise RuntimeError("Falta la variable de entorno DATABASE_URL en .env o entorno.")
...
def get_schema() -> str:
    #Devuelve un esquema simple: tablas y columnas usando el mismo engine.
