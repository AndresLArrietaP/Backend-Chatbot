...
def _reforzar_join_proyecto_modelo_aceite(q: str) -> str:
    return (
        ...
        + " | IMPORTANTE — CADENA DE JOIN para análisis de aceite con proyecto y/o modelo: "
          ...
          "OPTIMIZACIÓN: dentro del CTE, agrega el filtro "
          "LD.[FechaMuestreo] >= DATEADD(YEAR, -3, GETDATE()) para limitar el scan "
          "a datos de los últimos 3 años antes de calcular ROW_NUMBER — "
          "esto reduce el escaneo sin excluir datos históricos relevantes."
    )
